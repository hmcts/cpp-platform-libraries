...
public class EventApiInterceptorChainProviderTest {
    ...
    @InjectMocks
    private EventApiInterceptorChainProvider eventApiInterceptorChainProvider;
    ...
    public void shouldProvideDefaultInterceptorChainTypes() throws Exception {
        ...
        when(serviceComponentJndiConfig.isEventApiAuditEnabled()).thenReturn(true);

        eventApiInterceptorChainProvider.createInterceptorChainEntries();
        final List<InterceptorChainEntry> interceptorChainTypes = eventApiInterceptorChainProvider.interceptorChainTypes();
    ...
    public void shouldNotAddAuditInterceptorIfNotEnabledInConfiguration() throws Exception {
        ...
        when(serviceComponentJndiConfig.isEventApiAuditEnabled()).thenReturn(false);
