...
public class QueryControllerInterceptorChainProvider implements InterceptorChainEntryProvider {
    ...
    public void createInterceptorChainEntries() {
        ...
        if (serviceComponentJndiConfig.isQueryControllerAuditEnabled()) {
