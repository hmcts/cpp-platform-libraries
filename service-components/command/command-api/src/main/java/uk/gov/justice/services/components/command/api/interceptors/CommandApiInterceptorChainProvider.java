...
public class CommandApiInterceptorChainProvider implements InterceptorChainEntryProvider {
    ...
    public void createInterceptorChainEntries() {
        ...
        interceptorChainEntries.add(new InterceptorChainEntry(100, CommandApiDebugLoggingInterceptor.class));
        ...
        if (serviceComponentJndiConfig.isCommandApiAuditEnabled()) {
