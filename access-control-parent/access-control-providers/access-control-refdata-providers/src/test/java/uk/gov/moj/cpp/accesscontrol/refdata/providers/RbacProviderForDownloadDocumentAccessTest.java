...
public class RbacProviderForDownloadDocumentAccessTest extends RbacProviderBaseTest {

    @Test
    public void userIsNotAllowedToDownloadWhenRbacDocumentNotDefinedForDocumentType() {

        when(requester.request(any())).thenReturn(null);

        assertThat(rbacProvider.isLoggedInUserAllowedToDownloadDocument(buildAction()), is(false));

    }


    @Test
    public void userIsNotAllowedToDownloadWhenRbacDocumentDefinedForDocumentTypeWithNoUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToDownloadWhenRbacDocumentDefinedForDocumentTypeWithEmptyUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToDownloadWhenRbacDocumentDefinedForDocumentTypeWithUserGroupNotMatching() {
    ...
    @Test
    public void userIsNotAllowedToDownloadWhenNoUserDefinedForUsers() {
    ...
    @Test
    public void userIsAllowedToDownloadWhenRbacDocumentFoundForDocumentTypeWithExpiryDateToday() {
        ...
        assertThat(rbacProvider.isLoggedInUserAllowedToDownloadDocument(buildAction()), is(true));
    }

    @Test
    public void userIsAllowedToDownloadWhenRbacDocumentFoundForDocumentTypeWithStartDateToday() {
    ...
    @Test
    public void userIsAllowedToDownloadWhenRbacDocumentFoundForDocumentType() {
