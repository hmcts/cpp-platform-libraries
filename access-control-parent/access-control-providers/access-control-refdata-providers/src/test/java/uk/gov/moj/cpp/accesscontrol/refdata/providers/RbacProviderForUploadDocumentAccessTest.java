...
public class RbacProviderForUploadDocumentAccessTest extends RbacProviderBaseTest {

    @Test
    public void userIsNotAllowedToUploadWhenRbacDocumentNotDefinedForDocumentType() {

        when(requester.request(any())).thenReturn(null);

        assertThat(rbacProvider.isLoggedInUserAllowedToUploadDocument(buildAction()), is(false));

    }


    @Test
    public void userIsNotAllowedToUploadWhenRbacDocumentDefinedForDocumentTypeWithNoUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToUploadWhenRbacDocumentDefinedForDocumentTypeWithEmptyUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToUploadWhenRbacDocumentDefinedForDocumentTypeWithUserGroupNotMatching() {
    ...
    @Test
    public void userIsNotAllowedToUploadWhenNoUserDefinedForUsers() {
    ...
    @Test
    public void userIsAllowedToUploadWhenRbacDocumentFoundForDocumentTypeWithExpiryDateToday() {
        ...
        assertThat(rbacProvider.isLoggedInUserAllowedToUploadDocument(buildAction()), is(true));

    }

    @Test
    public void userIsAllowedToUploadWhenRbacDocumentFoundForDocumentTypeWithStartDateToday() {
    ...
    @Test
    public void userIsAllowedToUploadWhenRbacDocumentFoundForDocumentType() {
