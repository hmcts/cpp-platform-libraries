...
public class RbacProviderForDeleteDocumentAccessTest extends RbacProviderBaseTest {

    @Test
    public void userIsNotAllowedToDeleteWhenRbacDocumentNotDefinedForDocumentType() {

        when(requester.request(any())).thenReturn(null);

        assertThat(rbacProvider.isLoggedInUserAllowedToDeleteDocument(buildAction()), is(false));

    }


    @Test
    public void userIsNotAllowedToDeleteWhenRbacDocumentDefinedForDocumentTypeWithNoUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToDeleteWhenRbacDocumentDefinedForDocumentTypeWithEmptyUsersAssigned() {
    ...
    @Test
    public void userIsNotAllowedToDeleteWhenRbacDocumentDefinedForDocumentTypeWithUserGroupNotMatching() {
    ...
    @Test
    public void userIsNotAllowedToDeleteWhenNoUserDefinedForUsers() {
    ...
    @Test
    public void userIsAllowedToDeleteWhenRbacDocumentFoundForDocumentTypeWithExpiryDateToday() {
        ...
        assertThat(rbacProvider.isLoggedInUserAllowedToDeleteDocument(buildAction()), is(true));
    }

    @Test
    public void userIsAllowedToDeleteWhenRbacDocumentFoundForDocumentTypeWithStartDateToday() {

        final Map<String, String> dates = new HashMap<>();
        final LocalDate now = LocalDate.now();
        final LocalDate twodaysAfter = LocalDate.now().plusDays(2);
        dates.put("DOC-TYPE-VALLID-FROM", now.toString());
        dates.put("DOC-TYPE-VALLID-TO", twodaysAfter.toString());
    ...
    @Test
    public void userIsAllowedToDeleteWhenRbacDocumentFoundForDocumentType() {
