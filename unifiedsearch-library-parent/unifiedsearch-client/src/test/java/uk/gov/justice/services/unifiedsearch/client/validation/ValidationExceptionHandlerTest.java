...
public class ValidationExceptionHandlerTest {
    ...
    public void shouldFailToValidateJsonAgainstSchemaWhenThereIsJustOneValidationException() throws IOException {
        ...
        final ValidationException validationException = new ValidationException(violatedSchema, message, keyword);
    ...
    public void shouldFailToValidateJsonAgainstSchemaWhenThereIsMoreThanOneValidationException() throws IOException {
        ...
        final ValidationException validationException1 = new ValidationException(violatedSchema, message1, keyword);
        final ValidationException validationException2 = new ValidationException(violatedSchema, message2, keyword);
